...
<section>
    ...
    <div class="container-fruid">
        <div class="h-category-banner">
            <h2 class="text-center" data-aos="fade-up" data-aos-delay="200" style="color: #fff;">Khuyến mại</h2>
                ...
                <ul class="nav nav-tabs codong-tt" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                            aria-controls="home" aria-selected="true">Khuyến mại
                        </a>
                    </li>
                </ul>
                <!-- tin tức nội bộ -->
                                ...
                                <div class="row new_row">
                                    <div class="col-md-4">
                                        <div class="thumbnail text-center">
                                            <a href="khuyen-mai/{{ $item->slug }}"> <img src="images/{{ $item->image }}"
                                    ...
                                    <div class="col-md-8 blog-content">
                                        ...
                                        <a href="khuyen-mai/{{ $item->slug }}" class="ccc">
                                            <p>{{ $item->summary }}</p>
                                        </a>
                                        <a href="khuyen-mai/{{ $item->slug }}"
