...
<section>
  ...
  <h2 class="text-center" data-aos="fade-up" data-aos-delay="200" style="color: #fff;">CHÍNH SÁCH</h2>
 ...
 -->
                   <li class="nav-item">
                       <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                          aria-controls="home" aria-selected="true">Chính sách 
                        </a>
                    </li>
                   <!--  <li class="nav-item">
            ...
            <div class="col-md-3 tin-tuc-content" data-aos="fade-up" data-aos-delay="400">
                ...
                <ul class="list-group">
                    <li class="list-group-item text-center font-weight-bold"
                        style="background-color: #c18d28 ; color: white">Tin Tức nới nhất
                    </li>
                        ...
                        <div class="row naa">
                            ...
                            <div class="col-md-8" style="padding: 0 10px; font-size: 14px">
                                <a style="color: inherit;text-decoration: none;color: #505050;" href="{{route('policy_detail')}}"><span>Bếp ga Paloma PA-6MEJ siêu thị điện máy hc siêu thị hc</span></a>
                            </div>
                        </div>
