                ...
                <table class="table table-striped" id="example">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="center">
                                @if($row->active == 1)
                                    <a href="{{route('popup.active_edit',['id'=>$row->id])}}" <?php echo $active >= 2 ? 'onclick="return confirm("Cho hiện pop-up! Bạn có muốn tiếp tục?")"': 'onclick="return confirm("Cho hiện quá nhiều pop-up! Bạn có muốn tiếp tục?")"' ?> class="btn btn-xs btn-primary">Cho hiện</a>
                                @endif
                            </td>
