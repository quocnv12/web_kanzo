    ...
    <div class="page-title">
        <h3><span class="semi-bold">Tài Khoản</span></h3>
                ...
                <div class="alert bg-success" role="alert">
                    {{ session('thongbao') }}<a href="admin/phanquyen" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a>
                </div>
                @endif
                    ...
                    <tbody>
                        @foreach ($phanquyen as $item)
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <div>
                                        <a class="btn btn-primary" id="edit" href="admin/phanquyen/edit/{{ $item->id }}" onclick="">Sửa</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
