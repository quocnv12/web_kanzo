...
class news extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('news')->insert([
            ...
            [
                'summary'=>'GiadinhNet - Rất nhiều vụ tai nạn đáng tiếc xảy ra mà nguyên nhân từ sự thiếu hiểu biết của người tiêu dùng về gas.',
                'name'=>'Nguy hiểm lớn từ những sai lầm nhỏ',
                'slug'=>Str::slug('Nguy hiểm lớn từ những sai lầm nhỏ'),
                'content'=>'<p>Đ&acirc;y l&agrave; những mẹo nhỏ nhưng kh&ocirc;ng phải ai cũng biết gi&uacute;p tiết kiệm ga cho gia đ&igrave;nh.</p>
            ...
            [
                'summary'=>'Đây là những mẹo nhỏ nhưng không phải ai cũng biết giúp tiết kiệm ga cho gia đình.',
                'name'=>'Đun nấu xong nhớ bỏ 3s làm việc này, vừa tiết kiệm 50% ga lại an toàn, chống cháy nổ',
                'slug'=>Str::slug('Đun nấu xong nhớ bỏ 3s làm việc này, vừa tiết kiệm 50% ga lại an toàn, chống cháy nổ'),
                'content'=>'<p>Đ&acirc;y l&agrave; những mẹo nhỏ nhưng kh&ocirc;ng phải ai cũng biết gi&uacute;p tiết kiệm ga cho gia đ&igrave;nh.</p>
